...
public class Order_Screen_Modurpulav extends AppCompatActivity {
    ...
    int _counter = 1;
    String _stringval="199",count;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_order_modurpulav);
        ...
        _decrease.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if(_counter==1){
                    Toast.makeText(Order_Screen_Modurpulav.this, "Cant decrease ", Toast.LENGTH_SHORT).show();
                }else {
                    _counter--;
                    //       displayQuantity();
