...
public class Order_Screen_Pooran extends AppCompatActivity {
    ...
    int _counter = 1;
    String _stringval="100",count;
    int baseprice= 100;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_order_pooran);
        ...
        _decrease.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if(_counter==1){
                    Toast.makeText(Order_Screen_Pooran.this, "Cant decrease ", Toast.LENGTH_SHORT).show();
                }else {
                    _counter--;
                    //       displayQuantity();
