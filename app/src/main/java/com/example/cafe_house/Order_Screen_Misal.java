...
public class Order_Screen_Misal extends AppCompatActivity {
    ...
    int _counter = 1;
    String _stringval="99",count;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_order_misal);
        ...
        _decrease.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                if(_counter==1){
                    Toast.makeText(Order_Screen_Misal.this, "Cant decrease ", Toast.LENGTH_SHORT).show();
                }else {
                    _counter--;
                    //       displayQuantity();
