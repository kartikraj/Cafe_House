...
public class Order_Screen_Kadhi extends AppCompatActivity {
    ...
    int _counter = 1;
    int baseprice = 49;
    String _stringval="49",count;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_order__kadhi);
        ...
        _decrease.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (_counter == 1) {
                    Toast.makeText(Order_Screen_Kadhi.this, "Cant decrease ", Toast.LENGTH_SHORT).show();
                } else {
                    _counter--;
                    //       displayQuantity();
